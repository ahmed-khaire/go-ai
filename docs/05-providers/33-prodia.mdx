...
Prodia's language model handles img2img generation via multipart form-data. It accepts a text prompt and an optional input image and returns a transformed image along with an optional text description.
...
Prodia supports text-to-video and image-to-video generation with Wan 2.2 Lightning models.
...
|----------|------|-------------|
| `inference.wan2-2.lightning.txt2vid.v0` | T2V | Text-to-video generation |
| `inference.wan2-2.lightning.img2vid.v0` | I2V | Image-to-video generation |
