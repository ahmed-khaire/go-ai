...
- [Prodia](33-prodia.mdx) - Fast FLUX and Stable Diffusion image generation
...
| Prodia | FLUX, SD | Very Fast | High | Image + video |
...
**Image Generation**: Stability AI, Black Forest Labs, FAL, Prodia
