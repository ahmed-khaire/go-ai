		...
		if len(msg.Content) == 1 && msg.Content[0].ContentType() == "text" {
			...
			for _, part := range msg.Content {
				...
				case types.CustomContent:
					...
					// present; otherwise skip — custom parts are typically provider
					// metadata (citations, etc.) that should not be re-sent without
				...
				case types.ReasoningFileContent:
					// Reasoning files generated by the model are not re-sent to OpenAI.
